...
form. Sums the frozen V-JEPA2 encoder, the frozen Qwen2.5-1.5B decoder, and
...
def main():
    ...
    qwen = AutoModelForCausalLM.from_pretrained(QWEN_MODEL_ID)
    ...
    print(f"Qwen2.5-1.5B decoder (frozen): {fmt(qwen_params)}")
